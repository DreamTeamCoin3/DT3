...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid dreamteam3 address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid dreamteam3 address" in e.error['message'])
