...
DreamTeam3 Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadRPCServer : Remote procedure call handler, listens on port 5547 for connections and services them.
...
However, in open source software such as DreamTeam3 Core, where everyone uses
...
pay attention to for reviewers of DreamTeam3 Core code.

General DreamTeam3 Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: DreamTeam3 Core uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against DreamTeam3 Core so that they can be integrated
