...
This mechanism has been integrated into Bitcore-Node-DreamTeam3 which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dreamteam3pay/insight-api-dreamteam3#web-socket-api](https://github.com/dreamteam3pay/insight-api-dreamteam3#web-socket-api)
* API: [https://github.com/dreamteam3pay/insight-api-dreamteam3#instantsend-transactions](https://github.com/dreamteam3pay/insight-api-dreamteam3#instantsend-transactions)
...
By default, the DreamTeam3 Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the DreamTeam3 Core daemon:
