...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print DreamTeam3 address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "dreamteam3",               "masternode",             &masternode,             true,  {} },
    { "dreamteam3",               "masternodelist",         &masternodelist,         true,  {} },
    { "dreamteam3",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "dreamteam3",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "dreamteam3",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "dreamteam3",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
