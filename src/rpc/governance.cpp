...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in dreamteam3.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("dreamteam3.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* DreamTeam3 features */
    { "dreamteam3",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "dreamteam3",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "dreamteam3",               "gobject",                &gobject,                true,  {} },
    { "dreamteam3",               "voteraw",                &voteraw,                true,  {} },
