    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("DT3-light"), QVariant("light"));
    ui->theme->addItem(QString("DT3-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("DT3-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("DT3-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("DT3-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("DT3-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("DT3-traditional"), QVariant("trad"));
